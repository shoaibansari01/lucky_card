...
export default function Utility() {
  ...
  const handleAlgorithmPercentageChange = (e) => {
    const value = Math.max(0, Math.min(100, e.target.value)); // Ensure it's between 0 and 100
    setAlgorithmPercentage(value);
  };
        ...
        <div className="bg-white rounded-lg shadow-md p-6 w-80 text-center">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center justify-center mb-4">
              <input
                type="number"
                value={algorithmPercentage}
                onChange={handleAlgorithmPercentageChange}
